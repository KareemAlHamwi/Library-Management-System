...
return [
    ...
    'accepted_if' => 'حقل :attribute يجب أن يكون مقبولاً عندما يكون :other هو :value.',
    ...
    'doesnt_end_with' => 'حقل :attribute يجب ألا ينتهي بأحد ما يلي: :values.',
    'doesnt_start_with' => 'حقل :attribute يجب ألا يبدأ بأحد ما يلي: :values.',
    ...
    'in_array_keys' => 'حقل :attribute يجب أن يحتوي على الأقل على أحد المفاتيح التالية: :values.',
    ...
    'json' => 'حقل :attribute يجب أن يكون نصاً بصيغة JSON صالحة.',
    ...
    'missing_unless' => 'حقل :attribute يجب أن يكون غائباً ما لم يكن :other هو :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'كلمة المرور المدخلة ظهرت في تسريب بيانات. يرجى اختيار :attribute مختلف.',
    ],
